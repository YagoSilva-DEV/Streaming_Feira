                    ...
                    using (SqlCommand cmd = new SqlCommand(sql, conn))
                    {
                        ...
                        using (SqlDataReader reader = cmd.ExecuteReader())
                        {
                            while (reader.Read())
                            {
                                ...
                                contents.Add(new Content(id, contentName, synopsis, pathCoverFile, releaseDate, new Genre(id, genderName), new FilmMaker(id, filmmakerName)
                    ...
                    using (SqlCommand cmd = new SqlCommand(sql, conn))
                    {
                        ...
                        using (SqlDataReader reader = cmd.ExecuteReader())
                        {
                            while (reader.Read())
                            {
                                ...
                                contents.Add(new Content(id, contentName, synopsis, pathCoverFile, releaseDate, new Genre(id, genderName), new FilmMaker(id, filmmakerName), (ContentType)contentType));
                            }
                        }
                    }
                }
